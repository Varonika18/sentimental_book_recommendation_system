...
public class Login_Activity<LoginActivity> extends AppCompatActivity {
        ...
        private void resetPasswordUser() {
            ...
            {
                Toast.makeText(Login_Activity.this,"Please enter your email id",Toast.LENGTH_SHORT).show();
            }
            else
            {
        ...
        private void AllowUserToLogin() {
            ...
            if(TextUtils.isEmpty(email))
            {
                Toast.makeText(Login_Activity.this,"Please enter email id",Toast.LENGTH_SHORT).show();
            }
                ...
                mAuth.signInWithEmailAndPassword(email,pwd)
                        .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                {
                                    sendToMainActivity();
                                    Toast.makeText(Login_Activity.this,"Welcome to Reference Center",Toast.LENGTH_SHORT).show();
                                    loadingBar.dismiss();
                                }
                                else//Print the error message incase of failure
                                {
                                    String msg = task.getException().toString();
                                    Toast.makeText(Login_Activity.this,"Error: "+msg,Toast.LENGTH_SHORT).show();
                                    loadingBar.dismiss();
                                }
                            }
                        });
        ...
        private void sendToMainActivity() {
            ...
            Intent  MainIntent = new Intent(Login_Activity.this,MainActivity3.class);
